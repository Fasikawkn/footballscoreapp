class PlayerStatistics {
	...
	PlayerStatistics.fromJson(Map<String, dynamic> json) {
		...
		if (json['statistics'] != null) {
			...
			json['statistics'].forEach((v) { statistics!.add(Statistics.fromJson(v)); });
		}
	}
...
class Statistics {
	...
	Statistics.fromJson(Map<String, dynamic> json) {
		...
		substitutes = json['substitutes'] != null ? Substitutes.fromJson(json['substitutes']) : null;
		...
		tackles = json['tackles'] != null ? Tackles.fromJson(json['tackles']) : null;
		duels = json['duels'] != null ? Duels.fromJson(json['duels']) : null;
		dribbles = json['dribbles'] != null ? Dribbles.fromJson(json['dribbles']) : null;
...
class League {
  ...
  String? seasonRange;
	...
	League.fromJson(Map<String, dynamic> json) {
		...
		logo = json['logo'];
		flag = json['flag'];
    if(json['season'] is int){
      	season = json['season'];
        
    }else{
      	seasonRange = json['season'];
...
class Substitutes {
	...
	Substitutes({this.inS, this.out, this.bench});
