class GameMatchesHome{
  final int leagueId;
  final List<GameMatch> gameMatches;
  const GameMatchesHome({
...
class GameMatch {
  ...
  GameMatch({this.fixture, this.league, this.teams, this.goals, this.score});

  GameMatch.fromJson(Map<String, dynamic> json) {
    fixture =
...
class LeagueGameMatch{
  final String date;
  final List<GameMatch> games;
  const LeagueGameMatch({
    required this.date,
    required this.games,
  });
}